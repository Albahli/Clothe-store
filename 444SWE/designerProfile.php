<?php
session_start();
if(isset($_SESSION['login_user']) && isset($_SESSION['designerID']) && isset($_SESSION['brandName']) )
{
...
<!-- Bootstrap CSS -->
        ...
        <title><?php echo $brandName. " | Profile" ?> </title>
    </head>
                ...
                <div class="row">
                    <div class="col text-left">
                        ...
                        if($resultDesignerCheck>0)
                        {
                            ...
                            {
                                echo"
                                        <p>Brand Name: <span class='text-info'>".$row['brandName']."</span></p>
